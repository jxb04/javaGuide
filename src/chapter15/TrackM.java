package chapter15;
// Track mouse motion by drawing a line when a mouse button is pressed
...
public class TrackM extends Applet implements MouseListener, MouseMotionListener {
	...
	// The next three methods are not used, but must be null-implemented because they are
	...
	public void paint(Graphics g) {
		if (draw)
			g.drawLine(oldY, oldY, curX, curY);
	}

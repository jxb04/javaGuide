...
public class EffectsAndTransformsDemo extends Application {
	...
	public void start (Stage myStage) {
		...
		// Use a FlowPane for the root node.  IN this case, vertical and horizontal gaps of 20 are used.
		...
		btnRotate.setOnAction(new EventHandler<ActionEvent>() {
			public void handle(ActionEvent ae) {
				...
				// Each time a button is pressed, it is rotated 30 degrees around its cener
				angle += 15.0;

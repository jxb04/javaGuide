...
public class TextFieldDemo extends Application {
	...
	public void start(Stage myStage) {
		...
		// Use a lambda expression to handle action events for the text field.  Action events are 
		// generated when ENTER is pressed while the text field has input focus.  In this case, 

...
public class CBDemo implements ItemListener {
	...
	CBDemo() {
		...
		// Events generated by the check boxes are handled in common by the 
		// itemStateChanged() method implemented by CBDemo
		jcbAlpha.addItemListener(this);
		jcbBeta.addItemListener(this);
		jcbGamma.addItemListener(this);
		
		// Add check boxex and labels to the content pane
		jfrm.add(jcbAlpha);
		jfrm.add(jcbBeta);
		jfrm.add(jcbGamma);
	...
	public void itemStateChanged(ItemEvent ie) {               // Handle check box item events
		String str = "";

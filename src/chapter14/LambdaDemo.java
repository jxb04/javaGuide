...
public class LambdaDemo {
	public static void main(String args[]) {
		...
		// When it is assigned to myVal, a class instance is constructed in which the lambda
		// expression implements the getValue() method in MyValue
		...
		// Now, create a parameterized lambda expression and assign it to a MyParamValue reference.
		// This lambda expression returns the reciprocal of its argument.

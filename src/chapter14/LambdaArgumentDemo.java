...
public class LambdaArgumentDemo {
	...
	public static void main(String args[]) {
		...
		// Define a lambda expression that reverses the contents of a string and 
		// assign it to a StringFunc reference variable.
		...
		// It is embedded directly in the call to chgStr().
		...
		System.out.println("The string reversed case: " + outStr);
	}

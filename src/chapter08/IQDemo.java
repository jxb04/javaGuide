...
class CircularQueue implements ICharQ {
	...
	public void put(char ch) {
		 ...
		 * or if putloc is at the end of the array and getloc is at the beginning
		 */
		...
		q[putloc++] = ch;
		if (putloc == q.length) 
			putloc = 0;            // end of queue, loop back
	}
	...
	public char get() {
		...
		char ch = q[getloc++];
		if (getloc == q.length) 
			getloc = 0;  // end of queue, loop back
		return ch;
	}
}
